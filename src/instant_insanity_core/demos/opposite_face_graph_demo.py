from manim import tempconfig, ORIGIN, FadeIn, FadeOut, Text, Indicate
...
from instant_insanity_core.puzzle import WINNING_MOVES_PUZZLE, AxisLabel, PuzzleCubeNumber
...
from instant_insanity_core.mobjects.opposite_face_graph import OppositeFaceGraph, EdgeToSubgraphMapping
from instant_insanity_core.coordinate_grid import GridMixin
from instant_insanity_core.discussion import INDICATE_SCALE_FACTOR, INDICATE_TEXT_COLOUR
