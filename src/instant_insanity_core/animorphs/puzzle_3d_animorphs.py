...
from manim import Mobject, RIGHT, Scene
from manim.typing import Vector3D, Point3D

from instant_insanity_core.animorphs.animorph import Animorph
from instant_insanity_core.animorphs.cube_animorphs import CubeExplosionAnimorph
from instant_insanity_core.cube import FacePlane, FACE_PLANE_TO_VERTEX_PATH
from manim_cairo3d.geometry_types import PolygonKeyToVertexPathMapping, Point3D_Array
from instant_insanity_core.puzzle import PuzzleCubeNumber, FaceLabel, INITIAL_FACE_LABEL_TO_PLANE
from instant_insanity_core.transformation import transform_vertex_path
from instant_insanity_core.mobjects.puzzle_3d import Puzzle3D, Puzzle3DPolygonName
