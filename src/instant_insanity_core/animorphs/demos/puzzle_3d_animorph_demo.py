...
from instant_insanity_core.animorphs.puzzle_3d_animorphs import Puzzle3DTranslationAnimorph, \
    Puzzle3DCubeRotationAnimorph, morph_and_checkpoint
...
from instant_insanity_core.puzzle import Puzzle, PuzzleSpec, WINNING_MOVES_PUZZLE_SPEC, WINNING_MOVES_PUZZLE
