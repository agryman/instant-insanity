...
from instant_insanity_core.transformation import RigidMotion
from instant_insanity_core.mobjects.polygons_3d import Polygons3D


class Polygons3DAnimorph[KeyType](Animorph):
    """
    This is the abstract base class for Polygons3D animorphs.
    """
