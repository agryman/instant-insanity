...
from instant_insanity_core.puzzle import Puzzle, PuzzleCubeNumber, AxisLabel
...
from instant_insanity_core.solvers.graph_solver import GraphSolver, Grid, GridValue
