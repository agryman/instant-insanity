...
from instant_insanity_core.animorphs.puzzle_3d_animorphs import Puzzle3DAnimorph, Puzzle3DCubeRotationAnimorph, \
    Puzzle3DSetCubeGapAnimorph, morph_and_checkpoint
from instant_insanity_core.cube import FacePlane
from instant_insanity_core.cube_rotations import VisibleCubeTexts, PlaneToLabelMapping, INITIAL_PLANE_TO_LABEL_MAPPING, \
    mk_label_from_str, rotate_by_vector
from instant_insanity_core.puzzle import PuzzleCubeNumber, FaceLabel
from instant_insanity_core.mobjects.puzzle_3d import Puzzle3D, Puzzle3DPolygonName, DEFAULT_BUFF
