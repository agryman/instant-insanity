...
from instant_insanity_core.mobjects.stealth_tip import EdgeTip, mk_stealth_tip_at_node_boundary
from instant_insanity_core.mobjects.toy_example_graph import mk_link, mk_label, mk_node, NODE_RADIUS, TIP_SCALE, \
    TIP_WIDTH_RATIO
