...
from manim_cairo3d.projection import Projection
from instant_insanity_core.puzzle import PuzzleCubeSpec, PuzzleCube, FaceColour, FaceLabel, INITIAL_FACE_LABEL_TO_PLANE
from instant_insanity_core.mobjects.coloured_cube import MANIM_COLOUR_MAP
from instant_insanity_core.mobjects.polygons_3d import Polygons3D, DEFAULT_POLYGON_SETTINGS
