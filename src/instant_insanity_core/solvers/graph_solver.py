...
from instant_insanity_core.puzzle import Puzzle, AxisLabel, PuzzleCubeNumber, FaceColour, \
    PuzzleCube, CARTEBLANCHE_PUZZLE, WINNING_MOVES_PUZZLE, AXIS_TO_FACE_LABEL_PAIR, FaceLabelPair, \
    FaceLabel
