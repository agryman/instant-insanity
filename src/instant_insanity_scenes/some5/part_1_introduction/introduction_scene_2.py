...
from instant_insanity_core.animorphs.puzzle_3d_animorphs import Puzzle3DCubeRotationAnimorph, \
    Puzzle3DSetCubeGapAnimorph, \
    Puzzle3DTranslationAnimorph, morph_and_checkpoint
...
from instant_insanity_core.puzzle import PuzzleSpec, WINNING_MOVES_PUZZLE_SPEC, PuzzleCubeNumber, WINNING_MOVES_PUZZLE, \
    Puzzle, AxisLabel
from instant_insanity_core.mobjects.face_colour_table import FaceColourTable
from instant_insanity_core.mobjects.image import INTRODUCTION, INSTANT_INSANITY_SOURCE
from instant_insanity_core.mobjects.opposite_face_graph import EdgeToSubgraphMapping, OppositeFaceGraph
from instant_insanity_core.mobjects.puzzle_3d import Puzzle3D, mk_standard_puzzle3d, DEFAULT_BUFF
from instant_insanity_core.mobjects.puzzle_face_labeller import PuzzleFaceLabeller
# from instant_insanity_scenes.scenes import discussion
from instant_insanity_core.coordinate_grid import GridMixin
from instant_insanity_core.discussion import DiscussionMixin, PAGE_HEIGHT, INDICATE_SCALE_FACTOR, INDICATE_TEXT_COLOUR
