...
from instant_insanity_core.puzzle import WINNING_MOVES_PUZZLE, FaceLabel
...
# from instant_insanity_scenes.mobjects.zoom_image import GRAPH_THEORY, INTRODUCTION
from instant_insanity_core.discussion import DiscussionMixin, PAGE_HEIGHT
