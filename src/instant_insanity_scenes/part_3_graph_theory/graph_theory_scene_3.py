...
from instant_insanity_core.animorphs.animorph import Animorph
from instant_insanity_core.animorphs.polygon_to_dot_animorph import PolygonToDotAnimorph
from instant_insanity_core.animorphs.polygons_3d_animorphs import RigidMotionPolygons3DAnimorph
from instant_insanity_core.animorphs.puzzle_3d_animorphs import Puzzle3DAnimorph, Puzzle3DCubeExplosionAnimorph
...
from manim_cairo3d.projection import (
    Projection,
    PerspectiveProjection,
    OrthographicProjection,
    mk_standard_orthographic_projection,
)
from instant_insanity_core.puzzle import (PuzzleSpec, Puzzle, PuzzleCubeSpec, WINNING_MOVES_PUZZLE_SPEC,
                                          PuzzleCubeNumber, PuzzleCube, CubeAxis, AxisLabel,
                                          AXIS_TO_FACE_LABEL_PAIR, FaceLabelPair, FaceLabel,
                                          INITIAL_FACE_PLANE_TO_LABEL)
from instant_insanity_core.mobjects.labelled_edge import LabelledEdge, PointPair
from instant_insanity_core.mobjects.opposite_face_graph import OppositeFaceGraph, FaceData, mk_face_data_from_cube, \
    mk_face_data_from_puzzle
from instant_insanity_core.mobjects.puzzle_3d import Puzzle3D, Puzzle3DPolygonName, mk_standard_puzzle3d
