...
from instant_insanity_core.puzzle import Puzzle, PuzzleCubeNumber, AxisLabel, CubeAxis, WINNING_MOVES_PUZZLE, \
    PuzzleSpec, WINNING_MOVES_PUZZLE_SPEC, FaceColour
from instant_insanity_core.mobjects.coloured_cube import MANIM_COLOUR_MAP
from instant_insanity_core.mobjects.labelled_edge import LabelledEdge
from instant_insanity_core.mobjects.opposite_face_graph import OppositeFaceGraph, EdgeToSubgraphMapping, mk_edge_directions
from instant_insanity_core.mobjects.puzzle_3d import mk_standard_puzzle3d, DEFAULT_BUFF, Puzzle3D
from instant_insanity_core.mobjects.puzzle_face_labeller import PuzzleFaceLabeller
from instant_insanity_core.mobjects.quadrant import Quadrant
from instant_insanity_core.mobjects.stealth_tip import CubeEdgeTip
from instant_insanity_core.coordinate_grid import GridMixin
from kwargs_xyz_core.config import LINEN_CONFIG
from instant_insanity_core.discussion import DiscussionMixin, INDICATE_SCALE_FACTOR, INDICATE_TEXT_COLOUR
from instant_insanity_core.subscene import SubsceneMixin, Subscene
from instant_insanity_core.solvers.graph_solver import GraphSolver, Grid
...
class GraphTheoryScene4(GridMixin, SubsceneMixin, DiscussionMixin, VoiceoverScene):
    ...
    def subscene_3_discuss_starting_arrangement(self) -> None:
        ...
        scale_factor: float = INDICATE_SCALE_FACTOR
    ...
    def subscene_4_discuss_finding_subgraphs(self) -> None:
        ...
        self.play(Indicate(label_3x, scale_factor=INDICATE_SCALE_FACTOR, color=INDICATE_TEXT_COLOUR))
        ...
        self.play(Indicate(label_1z, scale_factor=INDICATE_SCALE_FACTOR, color=INDICATE_TEXT_COLOUR))
        ...
        self.play(Indicate(label_2y, scale_factor=INDICATE_SCALE_FACTOR, color=INDICATE_TEXT_COLOUR))
