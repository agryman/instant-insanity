...
IMAGE_PATH = "~/Documents/repositories/GitHub/agryman/instant-insanity/notebooks/images/scenes/introduction/"
...
class IntroductionScene(VoiceoverScene):
    def construct(self):
        ...
        instant_insanity_info: PuzzleInfo = PuzzleInfo(
            ...
            voiceover='...there was Instant Insanity.',
            year=1967,
