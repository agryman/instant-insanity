...
class OldCubeRigidMotionAnimator(OldCubeAnimator):
    """
...
class OldCubeExplosionAnimator(OldCubeAnimator):
    """
...
class ProjectedCube(Scene):
    def construct(self):
        ...
        cube_animation: OldCubeAnimator = OldCubeExplosionAnimator(cube_spec, projection, expansion_factor)
